...
namespace WebApi.App_Start
{
    ...
    public static class NinjectWebCommon 
    {
        ...
        private static void RegisterServices(IKernel kernel)
        {
            ...
            var logInstance = LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);
            kernel.Bind<ILog>().ToMethod(context => logInstance).InSingletonScope();
        }
    }
}